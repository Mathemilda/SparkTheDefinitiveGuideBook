...
# MAGIC %md
# MAGIC ## Chapter 25: Preprocessing and Feature Engineering
...
from pyspark.ml.feature import StandardScaler
sScaler = StandardScaler().setInputCol("features").setOutputCol("features_st_scaled")
sScaler.fit(scaleDF).transform(scaleDF).show()
...
minMax = MinMaxScaler().setMin(5).setMax(10).setInputCol("features").setOutputCol("features_minmax_scaled")
...
maScaler = MaxAbsScaler().setInputCol("features").setOutputCol("features_MaxAbs_scaled")
